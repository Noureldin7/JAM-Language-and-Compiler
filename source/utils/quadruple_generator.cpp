...
// 1- assign_op --> NOUR
// DONE: 2- jmp_unconditional op(label) --> NASHAR
// DONE: 3- jmp_on_condition(symbol, bool, label) --> ATAREK
// DONE: 4- push_op --> NASHAR
// DONE: 5- pop_op --> NASHAR
// 6- logical_op(&&,||)-->JOHN
// DONE: 7- relational_op -->(special cases for == and != (plus_op_like)) --> ATAREK
// 8- bitwise_op(&,|,^) --> JOHN
// 9- not_op{logical_op} --> JOHN
// 10- arth_op(+,-,*,/) --> NOUR
// DONE: 11- plus_op(+) --> ATAREK
// DONE: 12- concat_op(+) --> ATAREK
